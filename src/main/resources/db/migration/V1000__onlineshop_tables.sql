...
create table feedbacks (id integer not null auto_increment, date date, text varchar(255), client_id integer, product_id integer, primary key (id)) engine=InnoDB;
